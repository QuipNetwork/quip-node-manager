...
```sh
curl -fsSL https://gitlab.com/quip.network/quip-node-manager/-/raw/v0.2.0-rc7/scripts/install.sh | sh
```

**Windows (PowerShell):**

```powershell
irm https://gitlab.com/quip.network/quip-node-manager/-/raw/v0.2.0-rc7/scripts/install.ps1 | iex
```
